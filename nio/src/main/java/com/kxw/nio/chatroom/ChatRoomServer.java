 ...
 * <a href='http://www.cnblogs.com/yanghuahui/p/3686054.html'>@link</a>
 * <p>
 * TODO 客户端下线检测
 */
    ...
    public void BroadCast(Selector selector, SocketChannel except, String content) throws IOException {
        ...
        for (SelectionKey key : selector.keys()) {
            ...
            if (targetchannel instanceof SocketChannel && targetchannel != except) {
                ...
                System.out.println("send remote address: " + dest.getRemoteAddress().toString());
